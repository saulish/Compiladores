...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_declaraciones = 10,             /* declaraciones  */
...
static const char *const yytname[] =
{
  ...
  "IGUAL", "PUNTOYCOMA", "$accept", "programa", "declaraciones",
  "declaracion", "expr", YY_NULLPTR
};
...
#line 48 "parser.y"
      { agregar((yyvsp[-1].str), 0); /* 0 = int */ }
#line 1087 "parser.tab.c"
    break;

  case 6: /* declaracion: ID IGUAL expr PUNTOYCOMA  */
#line 52 "parser.y"
      {
        int t1 = buscar((yyvsp[-3].str));  
        int t2 = (yyvsp[-1].num);        
        if (t1 < 0)
